...
#define SKYVIEW_FIRMWARE_VERSION  "WAGA04B" 
...
{
	VIEW_MODE_RADAR,
	VIEW_MODE_NAV,// WAGA 070325 was previously VIEW_MODE_TABLE
	VIEW_MODE_TEXT
};
...
/*  WAGA 020425 removed this enum.  Voices nolonger selectable
enum
{
	VOICE_1,
	VOICE_2,
