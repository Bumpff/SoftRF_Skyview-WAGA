...
/*            GDL90      */
    ...
    char      Comp_ID[4];   // KW 080426 added this
} traffic_t;
...
#define ALARM_ZONE_CLOSE        6000  // metres, this determines min distance for alerts
...
#define ALARM_1_REPEAT          600  // WAGA 180425 buzzer settings
...
extern int FT; // First Threat = 0 or 1 position in Traffic array, depending if glider on tow

extern traffic_t ThisAircraft, Container[MAX_TRACKING_OBJECTS], fo, EmptyFO; // KW 080426  declares 4x objects as structures traffic_t
